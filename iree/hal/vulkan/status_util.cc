...
Status VkResultToStatus(const char* file, uint32_t line, VkResult result) {
  switch (result) {
    // Success codes.
    case VK_SUCCESS:
    ...
    case VK_ERROR_INITIALIZATION_FAILED:
      ...
      return InternalErrorBuilder(IREE_LOC) << "VK_ERROR_INITIALIZATION_FAILED";
    case VK_ERROR_DEVICE_LOST:
      ...
      return InternalErrorBuilder(IREE_LOC) << "VK_ERROR_DEVICE_LOST";
    case VK_ERROR_MEMORY_MAP_FAILED:
      // Mapping of a memory object has failed.
      return InternalErrorBuilder(IREE_LOC) << "VK_ERROR_MEMORY_MAP_FAILED";
    ...
    case VK_ERROR_SURFACE_LOST_KHR:
      ...
      return UnavailableErrorBuilder(IREE_LOC) << "VK_ERROR_SURFACE_LOST_KHR";
    ...
    default:
      return UnknownErrorBuilder(IREE_LOC) << result;
  }
}
