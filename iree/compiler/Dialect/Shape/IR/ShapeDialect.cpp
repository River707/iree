...
#include "mlir/Interfaces/ConstantFoldInterfaces.h"
...
struct ShapeConstantFoldInterface : public DialectConstantFoldInterface {
  using DialectConstantFoldInterface::DialectConstantFoldInterface;

  LogicalResult constantFold(
